class Logger {
	...
	static log(messages, logType = "DEFAULT") {
		...
		if (this.getCurrentLogLevel() >= logLevel) {
			...
			console.log(getMessageStart(logType), formatMessage(logMessage));
		}
	}
...
const formattingColors = {
	...
	b: colors.fgYellow, // build
	n: colors.fgGreen,  // number
	f: colors.fgCyan,   // filename
};
